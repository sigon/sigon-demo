...
<div style="width:556px;margin:0 auto;background:#F9FCFF">
    ...
    [#include "/include/mailTop.ftl"]
        <tr>
            <td style="background:#F9FCFF;font-weight: lighter;font-size:28px;letter-spacing:2px;line-height:80px;height:80px;padding: 0 0 0 9px" colspan="4">${headerTitle}</td>
        </tr>
        <tr>
            <td style="background:#F9FCFF;" colspan="4">
                <div style="background:#ffffff;border:1px solid #90999c;border-radius:6px;padding: 24px 32px;margin:0 0 40px 0">
                    ...
                    <p style="font-size:13px;line-height:18px;color:#636363;margin:0 0 16px 0;">[@aunewtop.message "mail.accountEmail.p1", lang/]</p>
